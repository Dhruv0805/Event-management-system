...
const Input = ({ label, name, error, className = '', ...rest }) => (
  <div className="flex min-w-0 flex-col gap-1.5">
    ...
    <input
      id={name}
      name={name}
      className={`w-full rounded-md bg-surface border border-border px-3.5 py-2.5 text-body-md text-text-primary placeholder:text-text-muted transition-colors focus:border-primary focus:ring-2 focus:ring-primary/25 outline-none ${
